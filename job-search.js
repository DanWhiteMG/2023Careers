...
//const url = _0xee6d[0]
const url = "https://prod-20.uksouth.logic.azure.com:443/workflows/4ada2311615f4959803e87bad2d3cca5/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=5tOfCYNWzo6_RcQ5HFwqjAZsdltIkuPQUYnbjT6bbPA";
...
function printArrayToDOM(array) {
	...
	// amend date format to UK date format for Last Updated Date
		...
		console.log('Hello ' + array[i].crfd0_recruitingstartdate@OData.Community.Display.V1.FormattedValue + '');	
